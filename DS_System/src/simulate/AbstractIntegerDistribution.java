...
public abstract class AbstractIntegerDistribution implements IntegerDistribution {
	/**
    ...
    public int inverseCumulativeProbability(final double p) throws OutOfRangeException {
        ...
        final double mu = getNumericalMean();                                                //得到期望
        final double sigma = FastMath.sqrt(getNumericalVariance());                          //得到根号下方差
